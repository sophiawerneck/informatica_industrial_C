...
class FormaBiDimensional
{
    ...
    public:
    virtual double calculaArea() = 0 ;//Todas as formas possuem area, mas ela e calculada diferente para cada forma  //tirando o virtual vai desabilitar o polimorfismo
