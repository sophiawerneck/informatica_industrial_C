...
int main()
{
    ...
    Pilha<int> p1(5); //T dentro da classe pilha vai assumir o valor de int para o objeto p1 //cria uma pilha de inteiros cujo objeto será p1
    Pilha<string> pString(5);//T dentro da classe pilha vai assumir o valor de string para o objeto pString //objeto da classe pilha 

    p1.insere(4);
    p1.insere(10); //o 10 vai sair primeiro pq é o último a entrar
